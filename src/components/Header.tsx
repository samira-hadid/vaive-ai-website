        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center cursor-pointer" onClick={() => { scrollToSection("hero") }}>
            <img
              ...
              alt="VAIVE.AI"
              className="h-12 sm:h-16 lg:h-14 w-auto me-4"
            />
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <a className="hover:text-white" href="https://platform.vaive.ai/"><Button
              variant="ghost"
              className="rounded-full text-white hover:text-white hover:bg-black border-60 hover:border hover:border-white/60 transition-all duration-300 font-light tracking-wide text-sm px-8 py-2"
            >
              Login
            </Button>
            </a>
            <a href="https://platform.vaive.ai/sign-up/">
              <Button
          ...
          <nav className="md:hidden mt-6 sm:mt-8 pb-6 sm:pb-8 border-t border-white/10">
            <div className="flex flex-col space-y-4 sm:space-y-6 pt-6 sm:pt-8">
              ...
              <div className="pt-4 sm:pt-6 flex flex-col space-y-3">
                <a className="hover:text-white" href="https://platform.vaive.ai/">
                  <Button
                    variant="ghost"
                    className="text-white hover:text-white hover:bg-white/5 border-0 w-full justify-start font-light text-base py-3 rounded-full"
                  >
                    Login
                  </Button>
                </a>
